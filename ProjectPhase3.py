...
# write the line of code that will open the file in append mode and assign it to EmpFile (Hint: see week 6, lab 2 as a guide)
    with open(FILENAME, "w") as EmpFile:
        #EmpDetailList = []
        ...
        while True:
                ...
                EmpDetail = fromdate + "|" + todate + "|" + empname + "|" + str(hoursworked) + "|" + str(hourlyrate) + "|" + str(taxrate) + "\n"
                print(EmpDetail)
                EmpFile.write(EmpDetail)
                # write the line of code that will write EmpDetail to the file
                EmpFile.close()
            # close file to save data ** extra code written
